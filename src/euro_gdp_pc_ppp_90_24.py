...
# TITLES & LABELS
plt.title("EUROPE & ANGLOSPHERE: GDP PER CAPITA 1990 - 2024 (PPP Constant 2021 Int$)",
...
# Save figure
output_file = FIGURES_DIR / 'euro_gdp_pc_ppp_heatmap.png'
